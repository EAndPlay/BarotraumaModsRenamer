Renames all installed Barotrauma mods from Steam WorkShop in "Mods" folder. Place .exe in "Mods" and it will rename all "\d{4,}" names into names saved in ...\filelist.xml
